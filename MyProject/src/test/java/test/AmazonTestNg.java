...
//	amazonSignInPage = new AmazonSignInPage(driver);
    ...
    //  amazonSearchReultPage= new AmazonSearchReultPage(driver);
	   ...
	   // amazonCartDetailsPage= new AmazonCartDetailsPage(driver);
		...
		AssertJUnit.assertEquals(expectedProductPrice, actualProductPrice);
		Thread.sleep(3000);
	}
	...
	//	rcommandedWishListModule = new RcommandedWishListModule(driver);
		...
		AssertJUnit.assertEquals(expectedWishListProductName,actualWishLishProductName);
		AssertJUnit.assertEquals(expectedWishListProductPrice, actualWishLishProductPrice);
